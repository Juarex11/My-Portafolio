...
const Navbar: React.FC = () => {
  ...
  const translations = {
    ...
    es: [
      ...
      { label: "Proyectos", target: "portfolio" },
    ...
    <nav className="fixed w-full bg-black/90 backdrop-blur-sm z-50 shadow-lg border-b border-gray-800">
      <div className="max-w-7xl mx-auto flex justify-between items-center py-4 px-4 sm:px-6 md:px-10">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <a
            href="https://api.whatsapp.com/send/?phone=51981031225&text=https%3A%2F%2Frjuarez.com%2F%0A%0A%C2%A1Deseo+crecer+con+ustedes%21+%F0%9F%9A%80%F0%9F%92%BC%F0%9F%8C%9F&type=phone_number&app_absent=0"
            target="_blank"
